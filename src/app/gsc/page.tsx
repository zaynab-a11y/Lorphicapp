...
export default async function GscPage() {
  ...
  return (
    ...
    >
      {/* Demo badge */}
      <div className="flex items-center gap-2 bg-yellow-400/10 border border-yellow-400/20 rounded-xl px-4 py-3 text-yellow-400 text-sm mb-6">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          <circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/>
        </svg>
        Demo Data — Live GSC integration coming soon. Data shown below is for illustration purposes only.
      </div>

      <div className="grid grid-cols-2 xl:grid-cols-4 gap-4 mb-6">
        <StatCard title="Total Clicks" value={summary.clicks.toLocaleString()} color="primary"
        ...
        <StatCard title="Impressions" value={summary.impressions.toLocaleString()} color="accent"
        ...
        <StatCard title="CTR" value={`${summary.ctr}%`} color="green"
        ...
        <StatCard title="Avg Position" value={summary.avgPosition} color="purple"
