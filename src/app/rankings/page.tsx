...
export default async function RankingsPage() {
  ...
  return (
    <DashboardLayout
      title="Rankings"
      subtitle="Your Google ranking screenshots"
    ...
    >
      ...
      <Card title="Ranking Screenshots" subtitle={items.length > 0 ? `${items.length} screenshots from your SEO manager` : 'No screenshots yet'}>
        {items.length === 0 ? (
